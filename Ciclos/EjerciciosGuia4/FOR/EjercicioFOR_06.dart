...
void main(List<String> args) {
  ...
  */
  ...
  int cant_jovenes = 0, cant_adultos = 0, cant_ninios = 0, cant_adultosMayores = 0, edad;
  double suma_jovenes = 0, suma_ninios = 0, suma_adultos = 0, suma_adultosMayores = 0, promedio_jovenes, promedio_ninios, promedio_adultos, promedio_adultosMayores, peso;
